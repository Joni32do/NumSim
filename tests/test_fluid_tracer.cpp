...
TEST(FluidTracer, DVDLogoBounceOff){
    ...
    // mask->makeRectangularObstacle({1.0, 1.0}, {0.1, 0.6}, {0.2, 0.2});
    // mask->makeRectangularObstacle({1.0, 1.0}, {0.5, 0.5}, {0.5, 0.5});

    // Initial values
    std::array<double, 2> vel = {-0.5*meshWidth[0], -0.5 * meshWidth[1]};
    // std::array<double, 2> vel = {meshWidth[0], meshWidth[1]};
    double dt = 1;
