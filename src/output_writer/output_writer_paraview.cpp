...
OutputWriterParaview::OutputWriterParaview(std::shared_ptr<Discretization> discretization, const Partitioning &partitioning) : OutputWriter(discretization, partitioning)
{
  // Create a vtkWriter_
